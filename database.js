...
//   // Insert dummy data for posts, replaced with the one below with user_Id
//   // db.run(`INSERT INTO posts (username, title, content, published_at) VALUES ('Junjie', 'Test Title', 'Testing', ?)`, [new Date().toISOString()]);
  
//   // Insert dummy data for posts with user_id
//   db.run(`INSERT INTO posts (user_id, username, title, content, published_at) VALUES (1, 'Junjie', 'Test Title', 'Testing', ?)`, [new Date().toISOString()]);

//   // Insert dummy posts for John Doe
//   db.run(`INSERT INTO posts (user_id, username, title, content, published_at) VALUES (1, 'John Doe', 'First Post', 'This is the content of John Doe''s first post.', ?)`, [new Date().toISOString()]);
//   db.run(`INSERT INTO posts (user_id, username, title, content, published_at) VALUES (1, 'John Doe', 'Second Post', 'This is the content of John Doe''s second post.', ?)`, [new Date().toISOString()]);

//   // Insert dummy posts for Jane Smith
//   db.run(`INSERT INTO posts (user_id, username, title, content, published_at) VALUES (2, 'Jane Smith', 'First Post', 'This is the content of Jane Smith\'s first post.', ?)`, [new Date().toISOString()]);
//   db.run(`INSERT INTO posts (user_id, username, title, content, published_at) VALUES (2, 'Jane Smith', 'Second Post', 'This is the content of Jane Smith\'s second post.', ?)`, [new Date().toISOString()]);  
